   ...
   // String birthDate = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU) {
            /*arrayPermission = {Manifest.permission.CAMERA,
                    Manifest.permission.READ_MEDIA_IMAGES}*/
            arrayPermission= new String[2];
arrayPermission[0] = Manifest.permission.CAMERA;
arrayPermission[1]= Manifest.permission.READ_MEDIA_IMAGES;
        }else{
            arrayPermission= new String[3];
          /*  arrayPermission = arrayOf(
            ...
            arrayPermission[0] = Manifest.permission.CAMERA;
            arrayPermission[1] = Manifest.permission.READ_EXTERNAL_STORAGE;
            arrayPermission[2] = Manifest.permission.WRITE_EXTERNAL_STORAGE;
        ...
        getViewBinding().postImageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new PermissionManager.Builder(ImageToTexttFragment.this)
                        .addPermissions(arrayPermission)
